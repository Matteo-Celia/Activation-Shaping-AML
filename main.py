...
def train(model: BaseResNet18, data):
    ...
    for epoch in range(cur_epoch, CONFIG.epochs):
        ...
        if CONFIG.experiment in ['random']:
            ...
            hook_handles.append(model.resnet.layer2[0].bn1.register_forward_hook(model.rec_actmaps_hook))
            hook_handles.append(model.resnet.layer2[0].bn1.register_forward_hook(model.asm_source_hook))
